...
CREATE TABLE SpotifyClone.usuarios(
    ...
    FOREIGN KEY fk_usuarios_planos (plano_id) REFERENCES planos(id)
) engine = InnoDB;
...
CREATE TABLE SpotifyClone.albuns(
    ...
    FOREIGN KEY fk_albuns_artistas (artista_id) REFERENCES artistas(id)
) engine = InnoDB;
...
CREATE TABLE SpotifyClone.musicas(
    ...
    FOREIGN KEY fk_musicas_albuns (album_id) REFERENCES albuns(id)
) engine = InnoDB;

CREATE TABLE SpotifyClone.artista_seguido(
    usuario_id INT NOT NULL,
    artista_id INT NOT NULL,
    CONSTRAINT PRIMARY KEY(usuario_id, artista_id),
    FOREIGN KEY fk_usuario_artista (usuario_id) REFERENCES usuarios(id),
    FOREIGN KEY fk_artista_usuario (artista_id) REFERENCES artistas(id)
) engine = InnoDB;
...
CREATE TABLE SpotifyClone.historico_reproducao(
    ...
    FOREIGN KEY fk_usuario_historico (usuario_id) REFERENCES usuarios(id),
    FOREIGN KEY fk_musica_historico (musica_id) REFERENCES musicas(id)
) engine = InnoDB;
...
INSERT INTO SpotifyClone.musicas (nome, duracao_segundos, album_id)
VALUES
  ('Soul For Us', 200, 1),
